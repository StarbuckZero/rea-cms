...
<section><p class="eyebrow">Content</p><div class="widget-heading mt-3"><h1 class="text-3xl font-bold">Blogs</h1><div class="button-row">
            <a class="button-secondary" href="/admin/plugins/blog/api-templates">Edit HTML / Text templates</a>
            <a class="button-primary" href="/cms/blog/new">New post</a>
        </div></div>
