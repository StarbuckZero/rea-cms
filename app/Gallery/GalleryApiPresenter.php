...
final class GalleryApiPresenter
{
    ...
    public function item(array $item): array
    {
        ...
        return [
            ...
            'media' => $url,
            'image' => $url,
            'thumbnail' => $mediaType === 'image' ? $url . '?thumbnail=1' : null,
    ...
    public function album(array $album): array
    {
        ...
        return [
            ...
            'cover' => $cover,
            // Albums and items share the same configurable Gallery templates.
            'media' => $cover,
            'image' => $hasPublicImage ? $cover . '?thumbnail=1' : $cover,
            'thumbnail' => $hasPublicImage ? $cover . '?thumbnail=1' : $cover,
            'altText' => (string) $album['title'],
            'caption' => (string) $album['description'],
            'mediaType' => 'image',
